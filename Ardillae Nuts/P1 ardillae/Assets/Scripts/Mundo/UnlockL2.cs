...
public class UnlockL2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //--------------------------
        //reiniciar varaibles (reset game progress)
    ...
    void Update()
    {
        //print(PlayerPrefs.GetInt("bool1"));
        //print("bool1: " + PlayerPrefs.GetInt("bool1") + "   bool2: " + PlayerPrefs.GetInt("bool2"));
        if (this.gameObject.name == "candado 1")
        {
            ...
            {
                nuez2.SetActive(false);
                this.GetComponent<Renderer>().enabled = true;// si se resetea eñ nvel que regrese todo
                // PlayerPrefs.SetInt("bool1", 0);
            }
        }
        ...
        if (this.gameObject.name == "candado 2")
        {
            ...
            else
            {
                ...
                // si se resetea eñ nvel que regrese todo
                //PlayerPrefs.SetInt("bool2", 0);
            }
        }
